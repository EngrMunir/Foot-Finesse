    ...
    <>
      <div className='container mx-auto'>
        ...
        <div className='mt-14 flex flex-col items-center justify-between gap-5 px-3 lg:mt-28 lg:flex-row'>
          ...
          {/* form section */}
          <div className='w-full rounded-lg border-[1px] border-secondary p-5 lg:w-1/2 lg:p-10'>
            <p className='mb-8 text-center text-3xl font-medium text-primary lg:text-4xl'>
              Get In Touch
            </p>
