        ...
        <div className='lg:flow-row mx-auto flex w-[90%] flex-col gap-20 lg:w-[85%] lg:flex-row'>
          ...
          <div>
            ...
            <div className=''>
              ...
              <button className='w-full bg-black rounded-lg p-3 text-base font-medium text-white shadow-none hover:scale-105 hover:shadow-none focus:scale-105 focus:shadow-none active:scale-100'>
